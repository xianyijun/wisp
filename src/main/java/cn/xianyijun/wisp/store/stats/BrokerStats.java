...
public class BrokerStats {
    ...
    public void record() {
        ...
        this.msgGetTotalTodayMorning =
                this.defaultMessageStore.getStoreStatsService().getGetMessageTransferMsgCount().get();
    ...
    public long getMsgGetTotalTodayNow() {
        return this.defaultMessageStore.getStoreStatsService().getGetMessageTransferMsgCount().get();
    }
}
